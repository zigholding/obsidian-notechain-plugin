...
:root {
    ...
    --msg-avatar-gap: 8px;
    --msg-opposite-gutter: calc(var(--msg-avatar-size) + var(--msg-avatar-gap) + 4px);
}
...
.message {
    ...
    margin-bottom: 10px;
    min-width: 0;
    max-width: min(calc(100% - var(--msg-opposite-gutter)), 760px);
    width: fit-content;
}

.message:has(.markdown-card),
.message:has(.jiujiu-proto-card) {
    width: min(calc(100% - var(--msg-opposite-gutter)), 680px);
    max-width: min(calc(100% - var(--msg-opposite-gutter)), 680px);
}
...
.message-body {
    ...
    flex: 1 1 auto;
    min-width: 0;
    max-width: calc(100% - var(--msg-avatar-size) - var(--msg-avatar-gap));
}
...
@media (max-width: 600px) {
    .message {
        max-width: calc(100% - var(--msg-opposite-gutter));
    }

    .message:has(.markdown-card),
    .message:has(.jiujiu-proto-card) {
        width: calc(100% - var(--msg-opposite-gutter));
        max-width: calc(100% - var(--msg-opposite-gutter));
    }
}
...
<div id="chat-wrapper">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            ...
            // 首次加载后滚到底部（显示最新消息）
            const msgRoot = getMessagesContainer();
            if (msgRoot) msgRoot.scrollTop = msgRoot.scrollHeight;
